...
const InfoTooltip = ({ text, label = 'More info' }) => {
    ...
    return (
        <span className="group/tip relative inline-flex align-middle">
            ...
            <span
                role="tooltip"
                className="pointer-events-none absolute left-0 top-[calc(100%+6px)] hidden w-[240px] max-w-[70vw] rounded-lg border border-border bg-surface-elevated p-2.5 text-[12px] font-normal leading-relaxed text-fg-muted group-hover/tip:block group-focus-within/tip:block"
