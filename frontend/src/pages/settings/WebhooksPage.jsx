                ...
                <div className="flex items-center gap-2">
                    {driftNames.length > 0 && (
                        <button
                            ...
                            className="touch-expand h-9 px-3 rounded-[7px] bg-warning/15 text-warning text-xs font-semibold hover:bg-warning/25 transition-colors disabled:opacity-50"
                        >
                    ...
                    <button
                        ...
                        className="touch-expand h-9 px-3 rounded-[7px] bg-primary text-on-color text-xs font-semibold hover:opacity-90 transition-opacity disabled:opacity-50"
                    >
